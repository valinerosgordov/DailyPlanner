...
internal static class LocEnStrings
{
    public static Dictionary<string, string> Build() => new()
    {
        ...
        ["CatWork"] = "Work (click to change)",
        ["CatStudy"] = "Study (click to change)",
        ["CatPersonal"] = "Personal (click to change)",
        ["CatHealthTip"] = "Health (click to change)",
        ...
        ["StateSelfReport"] = "Self-report (avg)",
        ["Close"] = "Close",
        ["Habits"] = "Habits",
        ["InboxTitle"] = "Inbox",
        ["InboxSearch"] = "Search…",
        ...
        ["CmdRun"] = "Run",
        ["CmdGoToToday"] = "Jump to today",
        ["CmdToggleSearch"] = "Search",
        ["CmdTogglePomodoro"] = "Pomodoro",
        ["CmdToggleFinance"] = "Finance",
        ["CmdToggleInbox"] = "Inbox",
        ["CmdToggleStatistics"] = "Statistics",
        ["CmdToggleSettings"] = "Settings",
        ["CmdWeeklyReview"] = "Weekly review",
        ["CmdExportExcel"] = "Export to Excel",
        ...
        ["SubBurdenLabel"] = "Subs/month",
        ["SubBurdenSubtitle"] = "effective burden",
        ["SubCountLabel"] = "Active",
        ["SubCountSubtitle"] = "subscriptions",
        ["SubAnnualLabel"] = "Annual",
        ["SubAnnualSubtitle"] = "forecast",
        ["SubSavingsLabel"] = "Saved/year",
        ["SubSavingsSubtitle"] = "vs monthly billing",
        ["SubStatusPaused"] = "Paused",
        ["SubStatusRecurring"] = "Recurring",
        ["SubStatusOverdue"] = "Overdue",
        ["SubStatusDueToday"] = "Due today",
        ["SubStatusDueSoon"] = "Due soon",
        ["SubStatusPending"] = "Active",
        ...
        ["MoveError"] = "Could not move the task. See app.log for details.",
