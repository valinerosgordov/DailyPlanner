...
internal static class LocEsStrings
{
    public static Dictionary<string, string> Build() => new()
    {
        ...
        ["CatWork"] = "Trabajo (clic para cambiar)",
        ["CatStudy"] = "Estudio (clic para cambiar)",
        ["CatPersonal"] = "Personal (clic para cambiar)",
        ["CatHealthTip"] = "Salud (clic para cambiar)",
        ...
        ["CmdNavigate"] = "Navegar",
        ["CmdRun"] = "Ejecutar",
        ["CmdGoToToday"] = "Ir a hoy",
        ["CmdToggleSearch"] = "Buscar",
        ["CmdTogglePomodoro"] = "Pomodoro",
        ["CmdToggleFinance"] = "Finanzas",
        ["CmdToggleInbox"] = "Bandeja",
        ["CmdToggleStatistics"] = "Estadísticas",
        ["CmdToggleSettings"] = "Ajustes",
        ["CmdWeeklyReview"] = "Resumen semanal",
        ["CmdExportExcel"] = "Exportar a Excel",
        ...
        ["BackupCorruptError"] = "Copia rechazada: la base de datos está corrupta. Recupera la base de datos primero.",
        ...
        ["SubBurdenLabel"] = "Subs/mes",
        ["SubBurdenSubtitle"] = "carga efectiva",
        ["SubCountLabel"] = "Activas",
        ["SubCountSubtitle"] = "suscripciones",
        ["SubAnnualLabel"] = "Anual",
        ["SubAnnualSubtitle"] = "proyección",
        ["SubSavingsLabel"] = "Ahorro/año",
        ["SubSavingsSubtitle"] = "vs mensual",
        ["SubStatusPaused"] = "En pausa",
        ["SubStatusRecurring"] = "Recurrente",
        ["SubStatusOverdue"] = "Vencido",
        ["SubStatusDueToday"] = "Hoy",
        ["SubStatusDueSoon"] = "Pronto",
        ["SubStatusPending"] = "Activa",
        ...
        ["MoveError"] = "No se pudo mover la tarea. Consulta app.log.",
