...
internal static class LocRuStrings
{
    public static Dictionary<string, string> Build() => new()
    {
        ...
        ["SubBurdenLabel"] = "Подписки/мес",
        ["SubBurdenSubtitle"] = "эффективная нагрузка",
        ["SubCountLabel"] = "Активных",
        ["SubCountSubtitle"] = "подписок",
        ["SubAnnualLabel"] = "Год вперёд",
        ["SubAnnualSubtitle"] = "прогноз",
        ["SubSavingsLabel"] = "Экономия/год",
        ["SubSavingsSubtitle"] = "vs ежемесячно",
        ["SubStatusPaused"] = "На паузе",
        ["SubStatusRecurring"] = "Регулярный",
        ["SubStatusOverdue"] = "Просрочено",
        ["SubStatusDueToday"] = "Сегодня",
        ["SubStatusDueSoon"] = "Скоро",
        ["SubStatusPending"] = "Активна",
        ["SubAuditTitle"] = "Пересмотри подписки",
        ["SubAuditBody"] = "{0} подп. не пересматривались более 90 дней",
        ["SubReminderToday"] = "Подписка списывается сегодня",
        ["SubReminderDaysBefore"] = "Подписка через {0} дн.",
        ["SubReminderBody"] = "{0} — {1:N2} {2}",
        ["MoveError"] = "Не удалось переместить задачу. Подробности в app.log.",
